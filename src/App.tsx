        	...
        	{!isAuthPage && <Header handleSandwichOnClick={toggleSidebar} />}
      		{!isAuthPage && (
				<Navbar isOpen={isNavbarOpen}>
					...
					<NavbarButton label="Pacientes" path="/admissions" icon={<AdmissionsSVG/>}/>
      		...
      		<ViewControl>
        		<Routes>
					...
					<Route path="/admissions" element={<ProtectedRoute> <Admission/> </ProtectedRoute>}>
						...
						<Route path="nuevopaciente" element = {<PostAdmission/>}/>
						<Route path="detallepaciente" element = {<GetOneAdmission id={admissionToShow}/>}/>
						<Route path="editarpaciente" element = {<PatchAdmission id={admissionToShow}/>}/>
